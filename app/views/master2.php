...
<head>
    ...
    <link rel="stylesheet" href="/DUAN1_NHOM1_QTT/public/css/style2t.css">
    <link rel="stylesheet" href="/DUAN1_NHOM1_QTT/public/css/styleqs.css">
    ...
    <div class="grid wide">
        ...
        <header class="header">
            ...
            <div class="col l-4 header-login">
                ...
                <div class="show_menu">
                    <ul class="user_list">
                        <a href="/DuAn1_Nhom1_QTT/user/Thong_tin_tai_khoan/<?=$_SESSION['id_nguoidung']?>"><li class="user_list-item">Trang Cá Nhân</li></a>
                        <a href="/DuAn1_Nhom1_QTT/user/Thay_doi_mat_khau/<?=$_SESSION['id_nguoidung']?>"><li class="user_list-item">Đổi mật khẩu</li></a>
                        <a href="/DuAn1_Nhom1_QTT/user/Dang_xuat"><li class="user_list-item">Đăng Xuất</li></a>
                    </ul>
                </div>
                </a>
                    <?php } else { ?>
