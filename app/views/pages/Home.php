...
<div class="row">
    ...
    <div class="col l-3 c-6">
        ...
        <h3><a href="/DuAn1_Nhom1_QTT/Tintuc/ChitietTin/<?=$tinxemnhieu['id_tintuc']?>"><?=$tinxemnhieu['tieu_de']?></a></h3>
        <div>
            <i class="ti-user"><?=$tinxemnhieu['so_luot_xem']?></i>
        </div>
    </div>
    <?php endforeach ?>
...
<div class="row">
    <?php foreach ($dsde as $de) : ?>
        <div class="col l-3 c-6">
            ...
            <h3><i class="ti-book topic_icon"></i><a href="#"><?= $de['ten_de'] ?></a></h3>
            <div>
