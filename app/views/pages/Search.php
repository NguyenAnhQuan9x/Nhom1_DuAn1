...
<div class="list-header">
    ...
    <a href="detailCousre.html">Xem chi tiết <i class="ti-angle-right list-header_icon"></i></a>
</div>
<div class="row">
    <div class="col l-3 c-6">
        <div class="course">
            ...
            <div class="course_detail">
                <div class="course_detail_text">
                    <a href="Khoahoc.html">Xem môn học</a>
                </div>
            </div>
        </div>
        <h3>Tin Tức</h3>
        <div>
            <i class="ti-user">8888</i>
        </div>
    </div>
    <div class="col l-3 c-6">
        <div class="course">
