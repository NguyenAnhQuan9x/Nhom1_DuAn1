<?php
    class ThongkeModel extends DB{
        ...
        public function khoahocnoibattklop($lop){
            ...
            ON dg.id_khoahoc = kh.id_khoahoc AND kh.id_lop = lh.id_lop AND kh.id_mon =mh.id_mon GROUP BY dg.id_khoahoc, kh.ten_khoahoc,kh.so_luot_xem,lh.ten_lop,mh.ten_mon HAVING danhgiatb >= 4 AND lh.ten_lop = '$lop' ORDER BY kh.so_luot_xem DESC LIMIT 0,4";
            return $this->pdo_query($sql);
        }
