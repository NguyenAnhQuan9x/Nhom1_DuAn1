...
<head>
    ...
    <link rel="stylesheet" href="../admin/public/css/master1.css">
</head>
<body>
    <header>
        <?php 
    ...
    <body>
        ...
        <div class="menu">
            ...
            <ul>
                <li>
                    <a href=""><span id="icon-content"><i class="fa-solid fa-house-chimney"></i></span >Trang chủ<span id="icon-show-detail"><i class="fa-solid fa-angle-down"></i></span></a>
                </li>
                <li>
                    <a href=""><span id="icon-content"><i class="fa-solid fa-folder-closed"></i></span >Môn học<span id="icon-show-detail"><i class="fa-solid fa-angle-down"></i></span></a>
                </li>
                <li>
                    <a href=""><span id="icon-content"><i class="fa-solid fa-address-card"></i></span >Lớp học<span id="icon-show-detail"><i class="fa-solid fa-angle-down"></i></span></a>
                </li>
                <li>
                    <a href=""><span id="icon-content"><i class="fa-solid fa-address-card"></i></span >Khóa học<span id="icon-show-detail"><i class="fa-solid fa-angle-down"></i></span></a>
                </li>
                <li>
